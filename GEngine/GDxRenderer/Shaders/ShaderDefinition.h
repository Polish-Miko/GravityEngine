...
#define GTAO_RESOLUTION_SCALE 0.5f

#define GTAO_USE_UPSAMPLE 0
...
#define DOF_FOCUS_DISTANCE 2000.0f
#define DOF_APERTURE 3.5f
#define DOF_FOCAL_LENGTH 1000.0f
